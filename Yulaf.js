...
moment.locale("tr");
kanal.send(`${config.kalp} ${member} (\`${member.id}\`) Eternal'e Hoşgeldin! ${config.kalp}
...
client.on("guildMemberAdd", member => {
if(member.user.username.includes("ꑕ") && (member.user.username.includes("Yasaklı Tag")) && (member.user.username.includes("Yasaklı tag") && (member.user.username.includes("Yasaklı Tag")))){
